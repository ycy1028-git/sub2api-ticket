...
INSERT INTO content_moderation_logs (
    ...
    category_scores, threshold_snapshot, input_excerpt, input_full, upstream_latency_ms, error,
    ...
    $22, $23, $24, $25, $26
		...
		string(categoryScores), string(thresholdSnapshot), log.InputExcerpt, log.InputFull, latency, log.Error,
